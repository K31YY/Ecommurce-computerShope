      ...
      <div className="">
        <div className=' m-5 w-screen  flex justify-center  '>
          <form className='w-96 flex items-center'>
            ...
            /><i style={{fontSize:20, marginInline:10}} class="fas fa-search"></i>
            {/* <h1 className='text-center my-5 text-3xl'> Choose the category</h1> */}
            
          </form>
        </div>
        <div className='w-screen  lg:flex lg:gap-10 lg:mx-5 sm:flex sm:m-10 flex-wrap sm:grid-cols-2 sm:gap-5 sm:items-center  '>
        ...
        <div className="grid lg:grid-cols-3 lg:grid-rows-10 sm:grid-cols-1 md:grid-cols-2 md p-10 gap-10 ProductBorder">
